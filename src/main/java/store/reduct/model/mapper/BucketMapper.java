...
@Mapper(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE, uses = {BucketSettingsMapper.class,
		EntryInfoMapper.class}, mappingControl = DeepClone.class)
