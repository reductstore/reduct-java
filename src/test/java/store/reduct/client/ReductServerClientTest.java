...
class ReductServerClientTest {
	...
	//
	// @Spy
	// private ServerProperties serverProperties = new ServerProperties(false,
	// "localhost", 8383);
	// @Mock
	...
	//
	// @Test
	// void getServerInfo_validDetails_returnServerInfo() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.SERVER_INFO);
	// HttpResponse<String> mockHttpResponse = mock(HttpResponse.class);
	// when(httpClient.send(httpRequest,
	// HttpResponse.BodyHandlers.ofString())).thenReturn(mockHttpResponse);
	...
	// }
	// @Test
	// void getServerInfo_serverReturnsMalformedJson_throwException() throws
	...
	// reductServerClient.getServerInfo());
	// //Assert
	// assertEquals("The server returned a malformed response.",
	// result.getMessage());
	// }
	// @Test
	// void getServerInfo_ioExceptionOccurs_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.SERVER_INFO);
	// when(httpClient.send(httpRequest,
	// HttpResponse.BodyHandlers.ofString())).thenThrow(IOException.class);
	// //Act
	// ReductSDKException result = assertThrows(ReductSDKException.class, () ->
	// reductServerClient.getServerInfo());
	// //Assert
	// assertEquals("An error occurred while processing the request",
	// result.getMessage());
	// }
	// @Test
	// void getServerInfo_threadInterrupted_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.SERVER_INFO);
	// when(httpClient.send(httpRequest,
	// HttpResponse.BodyHandlers.ofString())).thenThrow(InterruptedException.class);
	// //Act
	// ReductSDKException result = assertThrows(ReductSDKException.class, () ->
	// reductServerClient.getServerInfo());
	// //Assert
	// assertEquals("Thread has been interrupted while processing the request",
	// result.getMessage());
	// }
	// @Test
	// void getServerInfo_invalidToken_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.SERVER_INFO);
	// HttpResponse<String> mockHttpResponse = mock(HttpResponse.class);
	...
	// }
	// @Test
	// void getList_validDetails_returnServerInfo() throws IOException,
	// InterruptedException {
	// //Init
	...
	// }
	// @Test
	// void getList_serverReturnsMalformedJson_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.LIST);
	// HttpResponse<String> mockHttpResponse = mock(HttpResponse.class);
	...
	// //Act
	// ReductSDKException result = assertThrows(ReductSDKException.class, () ->
	// reductServerClient.getList());
	// //Assert
	// assertEquals("The server returned a malformed response.",
	// result.getMessage());
	// }
	// @Test
	// void getList_ioExceptionOccurs_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.LIST);
	// when(httpClient.send(httpRequest,
	...
	// }
	// @Test
	// void getList_threadInterrupted_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.LIST);
	// when(httpClient.send(httpRequest,
	...
	// }
	// @Test
	// void getList_invalidToken_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(ServerURL.LIST);
	// HttpResponse<String> mockHttpResponse = mock(HttpResponse.class);
	...
	// }
	// @Test
	// void isAlive_ioExceptionOccurs_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpHeadRequest(ServerURL.ALIVE);
	// when(httpClient.send(httpRequest,
	...
	// //Act
	// ReductSDKException result = assertThrows(ReductSDKException.class, () ->
	// reductServerClient.isAlive());
	// //Assert
	// assertEquals("An error occurred while processing the request",
	// result.getMessage());
	// }
	// @Test
	// void isAlive_threadInterrupted_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpHeadRequest(ServerURL.ALIVE);
	// when(httpClient.send(httpRequest,
	...
	// }
	// @Test
	// void isAlive_invalidToken_throwException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpHeadRequest(ServerURL.ALIVE);
	// HttpResponse<String> mockHttpResponse = mock(HttpResponse.class);
