...
class ReductTokenClientTest {
	...
	// reductTokenClient = new ReductTokenClient(serverProperties, httpClient,
	// accessToken);
	// }
	//
	// @Test
	// void createToken_validDetails_returnToken() throws IOException,
	...
	// doReturn(httpResponse).when(httpClient).send(httpRequest,
	...
	//
	// @Test
	// void createToken_tokenAlreadyExists_throwException() throws IOException,
	// InterruptedException {
	// HttpRequest httpRequest = buildCreateTokenRequest();
	...
	// doReturn(mockHttpResponse).when(httpClient).send(httpRequest,
	// HttpResponse.BodyHandlers.ofString());
	//
	...
	//
	// @Test
	// void createToken_serverReturnsInvalidJson_throwException() throws
	...
	//
	// @Test
	// void createToken_ioExceptionOccurs_throwException() throws IOException,
	// InterruptedException {
	// HttpRequest httpRequest = buildCreateTokenRequest();
	// doThrow(IOException.class).when(httpClient).send(httpRequest,
	// HttpResponse.BodyHandlers.ofString());
	...
	//
	// @Test
	// void createToken_threadInterrupted_throwException() throws IOException,
	// InterruptedException {
	// HttpRequest httpRequest = buildCreateTokenRequest();
	// doThrow(InterruptedException.class).when(httpClient).send(httpRequest,
	// HttpResponse.BodyHandlers.ofString());
	// ReductSDKException result = assertThrows(ReductSDKException.class,
	// () -> reductTokenClient.createToken(TOKEN_NAME,
	// TokenPermissions.of(true, List.of("test-bucket"), List.of("test-bucket"))));
	...
	// reductTokenClient.createToken(null,
	// TokenPermissions.of(true, List.of("test-bucket"), List.of("test-bucket"))));
	// }
	//
	// @Test
	...
	// assertThrows(IllegalArgumentException.class, () ->
	// reductTokenClient.createToken(TOKEN_NAME, null));
	// }
	//
	// @Test
	...
	// }
	// @Test
	// void getTokensIoExceptionOccursThrowException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(TokenURL.GET_TOKENS);
	// when(httpClient.send(httpRequest,
	...
	// //Act
	// ReductSDKException result = assertThrows(ReductSDKException.class, () ->
	// reductTokenClient.getTokens());
	// //Assert
	// assertEquals("An error occurred while processing the request",
	// result.getMessage());
	// }
	// @Test
	// void getTokensThreadInterruptedThrowException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(TokenURL.GET_TOKENS);
	// when(httpClient.send(httpRequest,
	...
	// }
	// @Test
	// void getTokensInvalidTokenThrowException() throws IOException,
	// InterruptedException {
	// //Init
	// HttpRequest httpRequest = createHttpGetRequest(TokenURL.GET_TOKENS);
	// HttpResponse<String> mockHttpResponse = mock(HttpResponse.class);
	...
	// String createTokenPath =
	// TokenURL.CREATE_TOKEN.getUrl().formatted(TOKEN_NAME);
	// URI createTokenUri =
	// URI.create("%s/%s".formatted(serverProperties.getBaseUrl(),
	// createTokenPath));
